...
import startMyBatch from '@salesforce/apex/BatchStarter.startMyBatch';
    ...
    handleMergeDuplicateAccounts(){
        ...
        startMyBatch({brand: this.currBrand, fromDate: dateTimeFromDate, toDate: dateTimeToDate})
            ...
            .catch(error => {
                ...
                const event = new ShowToastEvent({
                    title: 'Error',
                    message: 'An error occurred while starting the batch. Please try again.',
                    variant: 'error',
                    mode: 'dismissable'
                });
                this.dispatchEvent(event);
